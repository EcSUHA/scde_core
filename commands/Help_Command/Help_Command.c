...
//               display attributes 
			...
			strBufferOffset += snprintf(wBufStart + strBufferOffset
				...
				,"               "
				,(int) command->provided->helpString.len
				,command->provided->helpString.p_char	
				,(int) command->provided->helpDetailString.len
				,command->provided->helpDetailString.p_char);
